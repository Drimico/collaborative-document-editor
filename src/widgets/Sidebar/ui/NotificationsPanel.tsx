...
export const NotificationPanel = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Panel */}
      {open && (
        <div className="absolute bottom-12 left-0 w-80 max-h-96 overflow-y-auto rounded-2xl bg-(--bg) shadow-(--shadow-m) border border-white/10 flex flex-col gap-2 p-3 animate-fadeIn z-50">
