        ...
        {(isOpen || exiting) && (
          <>
            ...
            <div
              ...
              style={{
                animation: exiting
                  ? "popupExit 0.15s ease-in forwards"
                  : undefined,
              }}
            >
              <div className="flex flex-col items-center gap-1">
                <CircleUserRound size={40} className="text-(--text-muted)" />
              ...
              <label className="flex items-center gap-3 text-sm cursor-pointer group w-full px-3 py-2 rounded-lg hover:bg-black/10 transition-colors duration-150">
                <Palette size={18} className="text-(--text-muted) group-hover:text-(--text) transition-colors" />
